          ...
          <Hero tag="credit-card" width={320} height={480}>
            ...
            >
              ...
              <Column>
                <Text
                  text="BALANCE"
                  style={{ fontSize: 14, color: '#00E5FF80', letterSpacing: 2 }}
                />
                <Text
                  text="$24,599.00"
              ...
              <Column style={{ gap: 16 }}>
                <Text
                  text="**** **** **** 4281"
                  style={{ fontSize: 20, color: '#FFFFFF80', letterSpacing: 6 }}
                />
                <Row style={{ justifyContent: 'space-between', width: 256 }}>
                  <Column>
                    <Text
                      text="CARD HOLDER"
                      style={{ fontSize: 10, color: '#FFFFFF80' }}
                    />
                    <Text
                      text="ALEX PROTASSOV"
          ...
          <Column style={{ width: '100%', gap: 24 }}>
            ...
            >
              <Column>
                ...
                />
                <Text
                  text="Enable transactions on the internet"
            ...
            >
              <Column>
                <Text
                  text="International Usage"
                  style={{ fontSize: 16, color: theme.colors.textBody }}
                />
                <Text
                  text="Enable transactions abroad"
                  style={{ fontSize: 12, color: theme.colors.textSecondary }}
                />
              </Column>
              <Switch
                value={intlEnabled}
                onChange={setIntlEnabled}
                color="primary"
              />
            </Row>
            ...
            <Column style={{ gap: 16, padding: 16 }}>
              <Row style={{ width: '100%', justifyContent: 'space-between' }}>
                ...
                <Text
                  text={`$${limit}`}
                  style={{ fontSize: 16, fontWeight: 'bold', color: '#00E5FF' }}
                />
              </Row>
              <Slider
                value={limit}
